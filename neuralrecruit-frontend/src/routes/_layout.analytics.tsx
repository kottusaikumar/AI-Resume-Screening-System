      ...
      {!data && !error ? (
        ...
        <>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <section className="glass rounded-xl p-6">
              <h3 className="font-display font-semibold mb-4">Decision Governance</h3>
              <div className="rounded-lg border border-primary/25 bg-primary/5 p-4">
                <p className="text-sm font-medium">Human review is required for every candidate.</p>
                <p className="mt-2 text-xs text-muted-foreground">
                  Match scores organize evidence; they never automatically reject, advance, or
                  predict retention.
                </p>
              </div>
            </section>
